...
data = omniglotNShot.OmniglotNShotDataset(dataroot=dataroot, batch_size = batch_size,
                                          ...
                                          evaluation_input_file = sys.argv[8], evaluation_labels_file = sys.argv[14], evaluate_classes = int(sys.argv[25]), is_eval_with_train_data = int(sys.argv[26]), negative_test_offset = int(sys.argv[27]))
